...
public class ObjectFactory {
    ...
    private final static QName _GetRoleByUser_QNAME = new QName("http://api.ws.hai.com/", "getRoleByUser");
    private final static QName _GetRoleByUserResponse_QNAME = new QName("http://api.ws.hai.com/", "getRoleByUserResponse");
    private final static QName _GetRoles_QNAME = new QName("http://api.ws.hai.com/", "getRoles");
    private final static QName _GetRolesResponse_QNAME = new QName("http://api.ws.hai.com/", "getRolesResponse");
    private final static QName _Say_QNAME = new QName("http://api.ws.hai.com/", "say");
    private final static QName _SayResponse_QNAME = new QName("http://api.ws.hai.com/", "sayResponse");
